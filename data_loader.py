...
INTEREST_MAP = {
    # ── 기존 11개 ──────────────────────────────────────────────────────────────
    "수학":       {"gifted": ["수학", "수.과학"],              "job": ["수학", "통계"]},
    "과학":       {"gifted": ["과학", "수.과학", "융합"],       "job": ["과학", "화학", "물리", "생물"]},
    "컴퓨터":     {"gifted": ["정보과학"],                     "job": ["소프트웨어", "컴퓨터", "AI", "데이터"]},
    "AI":         {"gifted": ["정보과학", "융합"],              "job": ["인공지능", "AI", "소프트웨어", "데이터"]},
    "발명":       {"gifted": ["발명", "융합"],                 "job": ["발명", "특허", "기계", "로봇"]},
    "로봇":       {"gifted": ["정보과학", "융합", "과학"],      "job": ["로봇", "기계", "전자"]},
    "미술":       {"gifted": ["미술", "문화"],                 "job": ["미술", "디자인", "미디어"]},
    "음악":       {"gifted": ["음악"],                        "job": ["음악", "예술"]},
    "영어":       {"gifted": ["외국어"],                      "job": ["외국어", "번역", "통역"]},
    "인문":       {"gifted": ["인문사회"],                     "job": ["인문", "사회", "역사", "철학"]},
    "체육":       {"gifted": ["체육"],                        "job": ["체육", "스포츠"]},
    # ── 추가 20개 ──────────────────────────────────────────────────────────────
    "문제해결":   {"gifted": ["발명", "융합"],                 "job": ["발명", "설계", "기획"]},
    "일상개선":   {"gifted": ["발명", "융합"],                 "job": ["발명", "생활", "서비스"]},
    "아이디어":   {"gifted": ["발명", "융합"],                 "job": ["발명", "기획", "디자인"]},
    "코딩":       {"gifted": ["정보과학"],                     "job": ["소프트웨어", "컴퓨터", "프로그래밍"]},
    "프로그래밍": {"gifted": ["정보과학"],                     "job": ["소프트웨어", "컴퓨터", "데이터"]},
    "게임":       {"gifted": ["정보과학", "융합"],              "job": ["게임", "소프트웨어"]},
    "건축":       {"gifted": ["수학", "융합"],                 "job": ["건축", "설계", "디자인"]},
    "경제":       {"gifted": ["인문사회"],                     "job": ["경제", "금융", "경영"]},
    "심리":       {"gifted": ["인문사회"],                     "job": ["심리", "상담", "사회"]},
    "환경":       {"gifted": ["과학", "융합"],                 "job": ["환경", "생태", "지구과학"]},
    "의학":       {"gifted": ["과학", "수.과학"],              "job": ["의학", "생명과학", "바이오"]},
    "요리":       {"gifted": ["융합", "문화"],                 "job": ["요리", "식품", "영양"]},
    "패션":       {"gifted": ["미술", "문화"],                 "job": ["패션", "디자인", "미술"]},
    "영상":       {"gifted": ["미술", "융합"],                 "job": ["영상", "미디어", "콘텐츠"]},
    "글쓰기":     {"gifted": ["인문사회", "외국어"],            "job": ["작가", "언론", "출판"]},
    "천문":       {"gifted": ["과학", "수.과학"],              "job": ["천문", "우주", "물리"]},
    "로봇공학":   {"gifted": ["정보과학", "융합", "과학"],      "job": ["로봇", "기계", "전자"]},
    "생명과학":   {"gifted": ["과학", "수.과학"],              "job": ["생명과학", "바이오", "의학"]},
    "사진":       {"gifted": ["미술", "문화"],                 "job": ["사진", "미디어", "디자인"]},
    "스타트업":   {"gifted": ["융합", "발명"],                 "job": ["창업", "기획", "경영"]},
}
